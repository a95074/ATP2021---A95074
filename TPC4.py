 ...
 "cells": [
  {
   ...
   "source": [
    "**Keyname**: TPC 4\n",
    "**Título**: Operações com funções\n",
    "**Data de início:** 2020/11/04   \n",
    "**Data de fim:** 2020/11/21  \n",
    ...
    "**Resumo:** Este trabalho consiste na criação de um algoritmo que permite efetuar as seguintes operações: soma, subtração, divisão e multiplicação, através de duas frações.Este algoritmo, retorna o valor simplificado das frações, usando a máximo divisor comum."
   ]
  },
  {
   "cell_type": "code",
